...
function Navbar() {
  ...
  return (
    <div className="fixed top-0 left-0 z-50 w-full flex items-center justify-between px-6 md:px-16 lg:px-36 py-5">
      ...
      <div className="flex">
        <SearchIcon className="max-md:hidden md:mr-3 w-6 h-6 cursor-pointer" />
        {!user ? (
          <button
            onClick={() => openSignIn()}
            className="px-4 md:ml-5 py-1 sm:px-2 bg-primary hover:bg-primary-dull transition rounded-full font-medium cursor-pointer"
          >
            Login
          </button>
        ) : (
